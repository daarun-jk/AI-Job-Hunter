...
Return a JSON object with EXACTLY these keys (no markdown, no code blocks):
{
  ...
  "h1b_sponsored": "Based on your knowledge, does this company historically sponsor H1B visas in the US? Return boolean true if yes, false if no, or null if unknown",
...
Return ONLY the JSON object, no other text.`;
    ...
    try {
        ...
        return {
            ...
            h1b_sponsored: metadata.h1b_sponsored !== undefined ? metadata.h1b_sponsored : null,
...
app.post('/api/jobs/evaluate', async (req, res) => {
    try {
        ...
        const evaluationReport = {
            ...
            h1b_sponsored: jobMetadata.h1b_sponsored,
